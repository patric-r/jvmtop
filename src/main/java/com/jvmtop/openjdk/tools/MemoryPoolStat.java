...
public class MemoryPoolStat {
	...
	/**
	 * Returns the start time of the most recent GC on the memory pool for this
	...
	/**
	 * Returns the end time of the most recent GC on the memory pool for this
	 * statistics in milliseconds.
	 *
	 * Return 0 if no GC occurs.
	 */
	...
	/**
	 * Returns the memory usage before the most recent GC started. null if no GC
	 * occurs.
	 */
	...
	/**
	 * Returns the memory usage after the most recent GC finished. null if no GC
	 * occurs.
	 */
